...
public abstract class Level implements Bundlable {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		Collection<Bundlable> collection = bundle.getCollection( HEAPS, Bundlable.class );
		...
		collection = bundle.getCollection( PLANTS, Bundlable.class );
		...
		collection = bundle.getCollection( MOBS, Bundlable.class );
		...
		collection = bundle.getCollection( BLOBS, Bundlable.class );
